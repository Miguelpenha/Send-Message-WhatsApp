...
import messageBoletim from './messageBoletim'
...
async function messages(phoneToReceive: number) {
    ...
    console.log(await messageBoletim(phoneToReceive, 'https://images.unsplash.com/photo-1661961110372-8a7682543120', 'Miguel'))
}
